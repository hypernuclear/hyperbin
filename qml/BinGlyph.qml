...
Item {
    ...
    readonly property real viewHeight: 18
    ...
    Shape {
        ...
        ShapePath {
            ...
            PathSvg { path: "M8.07001 6.79C8.48001 6.94 8.91001 6.88 9.30001 6.73C9.74001 6.53 "
                  + "10.16 6.29 10.52 5.96C10.26 6.34 9.70001 6.93 9.26001 7.17C9.16001"
                  + " 7.81 8.97001 8.45 8.79001 8.94C9.19001 8.94 9.64001 8.95 10.15 8."
                  + "95C10.69 8.95 11.17 8.95 11.59 8.94C11.59 8.21 11.56 7.55 11.51 7."
                  ...
                  + "8001 4.63C8.10001 4.78 8.12001 4.95 8.21001 5.09C8.68001 5.01 8.98"
                  + "001 5.16 9.15001 5.46C9.63001 5.41 10.3 4.83 10.69 4.27C10.15 3.57"
        ...
        ShapePath {
            ...
            PathSvg { path: "M6.12002 8.39002C6.30002 8.45002 6.40002 8.63002 6.47002 8.83002C6"
                  + ".90002 8.87002 7.55002 8.91002 8.51002 8.93002C8.35002 8.24002 8.0"
        ...
        ShapePath {
            ...
            PathSvg { path: "M19.9799 9.55014C19.3899 9.80014 18.7699 9.99014 18.1599 10.0201C1"
                  ...
                  + ".00014 11.9399 8.93014C12.7199 8.91014 13.2699 8.88014 13.6699 8.8"
                  + "6014C13.5099 8.14014 13.4999 7.27014 13.8799 6.75014C14.1099 6.220"
                  + "14 15.4699 5.80014 15.7799 6.26014C15.8299 6.35014 15.8399 6.56014"
                  + " 15.7599 6.79014C14.5099 10.1701 17.3799 11.4901 20.0199 9.63014L1"
                  + "9.9799 9.56014V9.55014Z" }
        }
        ShapePath {
            strokeColor: "transparent"
            fillColor: root.color
            fillRule: ShapePath.WindingFill
            PathSvg { path: "M10.15 9.16998C7.47 9.16998 6.34 9.05998 5.88 8.97998L6.55 16.96C6"
                  + ".58 17.36 6.91 17.66 7.31 17.66H12.98C13.38 17.66 13.7 17.36 13.74"
                  + " 16.96L14.41 8.99998C13.95 9.06998 12.81 9.16998 10.15 9.16998ZM8."
                  + "75 16.23C8.44 16.25 8.17 16.01 8.15 15.69L7.88 12.17C7.86 11.86 8."
                  + "1 11.59 8.42 11.57C8.73 11.55 9.00001 11.79 9.02001 12.11L9.29 15."
                  + "63C9.31 15.94 9.07 16.21 8.75 16.23ZM12.14 15.7C12.12 16.01 11.86 "
                  + "16.25 11.54 16.24C11.23 16.22 10.99 15.95 11 15.64L11.27 12.12C11."
                  + "29 11.81 11.55 11.57 11.87 11.58C12.19 11.59 12.42 11.86 12.41 12."
                  + "18L12.14 15.7Z" }
        }
    }
}

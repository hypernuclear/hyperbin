    ...
    Shape {
        ...
        ShapePath {
            ...
            PathSvg { path: "M10.15 10.19C5.88 10.19 6.34 9.04998 5.88 8.97998L6.55 16.96C6.58 "
                              ...
                              + "L14.42 8.99998C13.96 9.06998 14.44 10.19 10.16 10.19H10.15Z M8.75 "
                              + "16.23C8.44 16.25 8.17 16.01 8.15 15.69L7.88 12.17C7.86 11.86 8.1 1"
                              + "1.59 8.42 11.57C8.73 11.55 9.00001 11.79 9.02001 12.11L9.29 15.63C"
                              + "9.31 15.94 9.07 16.21 8.75 16.23Z M12.14 15.7C12.12 16.01 11.86 16"
                              + ".25 11.54 16.24C11.23 16.22 10.99 15.95 11 15.64L11.27 12.12C11.29"
                              + " 11.81 11.55 11.57 11.87 11.58C12.19 11.59 12.42 11.86 12.41 12.18"
                              + "L12.14 15.7Z" }
        }
    }
}
